...
public class CopperWallBlock extends WallBlock implements ICopperFenceGate_BlockBase {
    ...
    public static final Supplier<BiMap<Block, Block>> WAXABLES = Suppliers.memoize(() -> ImmutableBiMap.<Block, Block>builder()
            .put(IronFenceRegistry.COPPER_WALL_BLOCK, IronFenceRegistry.WAXED_COPPER_WALL_BLOCK)
            .put(IronFenceRegistry.EXPOSED_COPPER_WALL_BLOCK, IronFenceRegistry.WAXED_EXPOSED_COPPER_WALL_BLOCK)
            .put(IronFenceRegistry.WEATHERED_COPPER_WALL_BLOCK, IronFenceRegistry.WAXED_WEATHERED_COPPER_WALL_BLOCK)
            .put(IronFenceRegistry.OXIDIZED_COPPER_WALL_BLOCK, IronFenceRegistry.WAXED_OXIDIZED_COPPER_WALL_BLOCK)
            .build());

    public static final Supplier<BiMap<Block, Block>> WAX_OFF_BY_BLOCK = Suppliers.memoize(() -> WAXABLES.get().inverse());


    public CopperWallBlock(ICopperFenceGate_BlockBase.CopperFenceGateWeatherState weatherState, FabricBlockSettings properties) {
        super(properties);
