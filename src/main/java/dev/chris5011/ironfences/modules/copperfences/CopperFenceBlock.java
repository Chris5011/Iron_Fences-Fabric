...
public class CopperFenceBlock extends FenceBlock implements ICopperFenceGate_BlockBase {
    ...
    public static final Supplier<BiMap<Block, Block>> WAXABLES = Suppliers.memoize(() -> ImmutableBiMap.<Block, Block>builder()
            .put(IronFenceRegistry.COPPER_FENCE_BLOCK, IronFenceRegistry.WAXED_COPPER_FENCE_BLOCK)
            .put(IronFenceRegistry.EXPOSED_COPPER_FENCE_BLOCK, IronFenceRegistry.WAXED_EXPOSED_COPPER_FENCE_BLOCK)
            .put(IronFenceRegistry.WEATHERED_COPPER_FENCE_BLOCK, IronFenceRegistry.WAXED_WEATHERED_COPPER_FENCE_BLOCK)
            .put(IronFenceRegistry.OXIDIZED_COPPER_FENCE_BLOCK, IronFenceRegistry.WAXED_OXIDIZED_COPPER_FENCE_BLOCK)
            .build());

    public static final Supplier<BiMap<Block, Block>> WAX_OFF_BY_BLOCK = Suppliers.memoize(() -> WAXABLES.get().inverse());


    public CopperFenceBlock(ICopperFenceGate_BlockBase.CopperFenceGateWeatherState weatherState, FabricBlockSettings properties) {
        super(properties);
